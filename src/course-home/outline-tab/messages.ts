...
const messages = defineMessages({
  allDates: {
    ...
    defaultMessage: 'Xem tất cả các ngày quan trọng của khóa học',
  ...
  editGoal: {
    ...
    defaultMessage: 'Chỉnh sửa mục tiêu',
  ...
  goalReminderDetail: {
    ...
    defaultMessage: 'Nếu chúng tôi nhận thấy bạn chưa đạt mục tiêu, chúng tôi sẽ gửi email nhắc nhở.',
    description: 'It describe to learner what is goal reminder service',
  },
  goalUnsure: {
    id: 'learning.outline.goalUnsure',
    defaultMessage: 'Chưa chắc',
  },
  handouts: {
  ...
  incompleteSection: {
    ...
    defaultMessage: 'Phần chưa hoàn thành',
  ...
  proctoringInfoPanel: {
    ...
    defaultMessage: 'Khóa học này có bài kiểm tra giám sát',
  ...
  resumeBlurb: {
    ...
    defaultMessage: 'Tiếp tục từ nơi bạn đã dừng lại',
  ...
  setGoal: {
    ...
    defaultMessage: 'Để bắt đầu, hãy đặt mục tiêu khóa học bằng cách chọn tùy chọn phù hợp với kế hoạch học tập của bạn bên dưới.',
    description: 'In indicate to learner how to set or use the goal reminder service',
  },
  setGoalReminder: {
    id: 'learning.outline.setGoalReminder',
    defaultMessage: 'Đặt nhắc nhở mục tiêu',
  ...
  setLearningGoalButtonScreenReaderText: {
    ...
    defaultMessage: 'Chọn mức độ mục tiêu học tập.',
  ...
  setWeeklyGoal: {
    ...
    defaultMessage: 'Đặt mục tiêu học tập hàng tuần',
    description: 'The headline for (goal reminder service) section in course outline',
  },
  setWeeklyGoalDetail: {
    id: 'learning.outline.setWeeklyGoalDetail',
    defaultMessage: 'Đặt mục tiêu giúp bạn hoàn thành khóa học. Bạn luôn có thể thay đổi sau.',
    description: 'It indiacate the gaol or purpose of the goal reminder service to learners',
  },
  start: {
  ...
  startBlurb: {
    ...
    defaultMessage: 'Bắt đầu khóa học ngay hôm nay',
  },
  tools: {
    id: 'learning.outline.tools',
    defaultMessage: 'Công cụ khóa học',
  ...
  welcomeMessageShowLessButton: {
    ...
    defaultMessage: 'Hiển thị ít hơn',
  },
  welcomeTo: {
  ...
  otherCourseApprovedProctoringStatus: {
    ...
    defaultMessage: 'Đã xác nhận ở khóa học khác',
  ...
  proctoringCurrentStatus: {
    ...
    defaultMessage: 'Trạng thái onboarding hiện tại:',
  ...
  notStartedProctoringMessage: {
    ...
    defaultMessage: 'Bạn chưa bắt đầu bài kiểm tra onboarding.',
  ...
  startedProctoringMessage: {
    ...
    defaultMessage: 'Bạn đã bắt đầu bài kiểm tra onboarding.',
  ...
  submittedProctoringMessage: {
    ...
    defaultMessage: 'Bạn đã nộp bài kiểm tra onboarding.',
  ...
  verifiedProctoringMessage: {
    ...
    defaultMessage: 'Bài kiểm tra onboarding của bạn đã được xác nhận trong khóa học này.',
  ...
  rejectedProctoringMessage: {
    ...
    defaultMessage: 'Bài kiểm tra onboarding của bạn bị từ chối. Vui lòng thử lại.',
  ...
  errorProctoringMessage: {
    ...
    defaultMessage: 'Đã xảy ra lỗi trong quá trình làm bài kiểm tra onboarding. Vui lòng thử lại.',
  ...
  otherCourseApprovedProctoringMessage: {
    ...
    defaultMessage: 'Bài kiểm tra onboarding của bạn đã được xác nhận ở khóa học khác.',
  ...
  otherCourseApprovedProctoringDetail: {
    ...
    defaultMessage: 'Nếu thiết bị của bạn đã thay đổi, chúng tôi khuyến nghị bạn hoàn thành bài kiểm tra onboarding của khóa học này để đảm bảo thiết lập vẫn đáp ứng yêu cầu giám sát.',
  ...
  expiringSoonProctoringMessage: {
    ...
    defaultMessage: 'Hồ sơ onboarding của bạn đã được xác nhận, nhưng sắp hết hạn. Vui lòng hoàn thành lại onboarding để tiếp tục tham gia các bài kiểm tra giám sát.',
  ...
  expiredProctoringMessage: {
    ...
    defaultMessage: 'Trạng thái onboarding của bạn đã hết hạn. Vui lòng hoàn thành lại onboarding để tiếp tục tham gia các bài kiểm tra giám sát.',
  ...
  proctoringPanelGeneralInfo: {
    ...
    defaultMessage: 'Bạn phải hoàn thành quá trình onboarding trước khi tham gia bất kỳ bài kiểm tra giám sát nào.',
  ...
  proctoringPanelGeneralInfoSubmitted: {
    ...
    defaultMessage: 'Hồ sơ bạn đã nộp đang được xem xét.',
  ...
  proctoringPanelGeneralTime: {
    ...
    defaultMessage: 'Quá trình xem xét hồ sơ onboarding có thể mất hơn 2 ngày làm việc.',
  ...
  proctoringOnboardingButton: {
    ...
    defaultMessage: 'Hoàn thành onboarding',
  ...
  proctoringOnboardingPracticeButton: {
    ...
    defaultMessage: 'Xem bài kiểm tra onboarding',
  ...
  proctoringOnboardingButtonNotOpen: {
    ...
    defaultMessage: 'Onboarding mở từ: {releaseDate}',
  ...
  proctoringReviewRequirementsButton: {
    ...
    defaultMessage: 'Xem hướng dẫn và yêu cầu hệ thống',
  ...
  proctoringOnboardingButtonPastDue: {
    ...
    defaultMessage: 'Onboarding quá hạn',
  ...
  sequenceDueDate: {
    ...
    defaultMessage: '{description} hạn nộp {assignmentDue}',
