...
const messages = defineMessages({
  ...
  completionBody: {
    ...
    defaultMessage: 'Điều này biểu thị mức độ bạn đã hoàn thành nội dung khóa học. Lưu ý rằng một số nội dung có thể chưa được phát hành.',
  ...
  lockedContentTooltip: {
    ...
    defaultMessage: 'Nội dung bị khóa và chỉ dành cho những người nâng cấp.',
  ...
  percentLocked: {
    ...
    defaultMessage: '{percent}% nội dung trong khóa học này bị khóa và chỉ dành cho những người nâng cấp.',
