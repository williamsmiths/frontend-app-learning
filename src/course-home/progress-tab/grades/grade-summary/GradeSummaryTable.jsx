        ...
        columns={[
          {
            ...
            headerClassName: 'h5 mb-0 fw-bold text-gray-700 p-2',
          },
          {
            Header: `${intl.formatMessage(messages.weight)}`,
            accessor: 'weight',
            headerClassName: 'justify-content-end h5 mb-0 fw-bold text-gray-700 p-2',
          ...
          },
          {
            ...
            headerClassName: 'justify-content-end h5 mb-0 text-right fw-bold text-gray-700 p-2',
