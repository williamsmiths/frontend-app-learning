...
const messages = defineMessages({
  ...
  requirementsHeader: {
    ...
    defaultMessage: 'Yêu cầu nhận tín chỉ khóa học',
  ...
  creditEligibleStatus: {
    ...
    defaultMessage: `Bạn đã đáp ứng các yêu cầu để nhận tín chỉ trong khóa học này. Truy cập
      {dashboardLink} để mua tín chỉ khóa học. Hoặc tìm hiểu thêm về {creditLink}.`,
  ...
  creditPartialEligibleStatus: {
    ...
    defaultMessage: 'Bạn chưa đáp ứng đủ các yêu cầu để nhận tín chỉ. Tìm hiểu thêm về {creditLink}.',
