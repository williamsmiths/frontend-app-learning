...
const messages = defineMessages({
  ...
  notPassingBody: {
    ...
    defaultMessage: 'Để đủ điều kiện nhận chứng chỉ, bạn phải đạt điểm đạt yêu cầu.',
  ...
  inProgressBody: {
    ...
    defaultMessage: 'Có vẻ như còn nội dung trong khóa học này sẽ được phát hành trong tương lai. Hãy theo dõi email hoặc quay lại khóa học để biết khi nào nội dung này sẽ có sẵn.',
  ...
  requestableBody: {
    ...
    defaultMessage: 'Chúc mừng, bạn đủ điều kiện nhận chứng chỉ! Để truy cập chứng chỉ của bạn, hãy yêu cầu bên dưới.',
  ...
  unverifiedPendingBody: {
    ...
    defaultMessage: 'Việc xác thực ID của bạn đang chờ xử lý và chứng chỉ của bạn sẽ có sẵn khi được phê duyệt.',
  ...
  upgradeBody: {
    ...
    defaultMessage: 'Bạn đang ở chế độ audit và không đủ điều kiện nhận chứng chỉ. Để làm việc để nhận chứng chỉ, hãy nâng cấp khóa học ngay hôm nay.',
  ...
  unverifiedHomeHeader: {
    ...
    defaultMessage: 'Xác thực danh tính của bạn để đủ điều kiện nhận chứng chỉ.',
  ...
  unverifiedHomeButton: {
    ...
    defaultMessage: 'Xác thực ID của tôi',
  ...
  unverifiedHomeBody: {
    ...
    defaultMessage: 'Để tạo chứng chỉ cho khóa học này, bạn phải hoàn tất quá trình xác thực ID.',
