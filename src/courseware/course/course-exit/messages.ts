...
const messages = defineMessages({
  ...
  certificateHeaderNotAvailable: {
    ...
    defaultMessage: 'Điểm và trạng thái chứng chỉ của bạn sẽ sớm có.',
  ...
  certificateNotAvailableBodyAccessCert: {
    ...
    defaultMessage: 'Nếu bạn đã đạt điểm đủ, chứng chỉ sẽ được cấp tự động.',
  ...
  certificateNotAvailableEndDateBody: {
    ...
    defaultMessage: 'Điểm cuối cùng và bất kỳ chứng chỉ nào đạt được sẽ có sau {endDate}.',
  ...
  certificateHeaderUnverified: {
    ...
    defaultMessage: 'Bạn phải hoàn thành xác minh để nhận chứng chỉ.',
  ...
  certificateHeaderRequestable: {
    ...
    defaultMessage: 'Chúc mừng, bạn đủ điều kiện nhận chứng chỉ!',
  ...
  certificateHeaderUpgradable: {
    ...
    defaultMessage: 'Nâng cấp để nhận chứng chỉ xác minh',
  ...
  courseInProgressDescription: {
    ...
    defaultMessage: 'Có vẻ như còn nhiều nội dung trong khóa học này sẽ được phát hành sau. Hãy chú ý email hoặc kiểm tra lại khóa học của bạn khi nội dung này có sẵn.',
  ...
  courseInProgressHeader: {
    ...
    defaultMessage: 'Nội dung mới sẽ sớm có!',
  ...
  endOfCourseDescription: {
    ...
    defaultMessage: 'Rất tiếc, bạn hiện chưa đủ điều kiện nhận chứng chỉ. Bạn cần đạt điểm qua để đủ điều kiện.',
  ...
  microBachelorsLearnMore: {
    ...
    defaultMessage: 'Tìm hiểu cách chứng chỉ MicroBachelors của bạn có thể được áp dụng cho tín chỉ.',
  },
  microMastersLearnMore: {
    id: 'courseExit.programs.microMasters.learnMore',
    defaultMessage: 'Tìm hiểu về quy trình áp dụng chứng chỉ MicroMasters cho bằng Thạc sĩ.',
  },
  microMastersMessage: {
    id: 'courseExit.programs.microMasters.mastersMessage',
    defaultMessage: 'Nếu bạn muốn sử dụng chứng chỉ MicroMasters cho chương trình Thạc sĩ, bạn có thể bắt đầu ngay hôm nay!',
  },
  nextButtonComplete: {
  ...
  nextButtonEnd: {
    ...
    defaultMessage: 'Tiếp theo (cuối khóa học)',
  ...
  requestCertificateBodyText: {
    ...
    defaultMessage: 'Để nhận chứng chỉ, hãy yêu cầu bên dưới.',
  ...
  verificationPending: {
    ...
    defaultMessage: 'Xác minh ID của bạn đang chờ và chứng chỉ sẽ có khi được phê duyệt.',
