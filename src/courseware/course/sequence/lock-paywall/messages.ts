...
const messages = defineMessages({
  'learn.lockPaywall.title': {
    ...
    defaultMessage: 'Bài tập được chấm điểm đã bị khóa',
  ...
  'learn.lockPaywall.content.pastExpiration': {
    ...
    defaultMessage: 'Hạn nâng cấp cho khóa học này đã qua. Để nâng cấp, hãy đăng ký vào kỳ học tiếp theo có sẵn.',
